...
var refused = map[string]bool{
	...
	"loop.lease.acquired":                 true,
	"loop.lease.renewed":                  true,
	"loop.lease.released":                 true,
	"loop.lease.stolen":                   true,
	"loop.lease.refused":                  true,
	"loop.checkpoint.requested":           true,
	"loop.checkpoint.approved":            true,
	"loop.checkpoint.rejected":            true,
	"loop.checkpoint.consumed":            true,
	"loop.pass.started":                   true,
	"loop.pass.planned":                   true,
	"loop.pass.completed":                 true,
	"loop.pass.failed":                    true,
	"loop.pass.resumable":                 true,
	"loop.pass.resumed":                   true,
	"loop.pass.check.passed":              true,
	"loop.pass.worker.started":            true,
	"loop.pass.worker.completed":          true,
	"loop.pass.checks.completed":          true,
	"loop.pass.commit.started":            true,
	"loop.pass.commit.completed":          true,
	"loop.pass.push.started":              true,
	"loop.pass.push.completed":            true,
	"loop.pass.push.reconciling":          true,
	"loop.pass.push.reconciled":           true,
	"loop.pass.worktree.cleaned":          true,
	"loop.pass.checkpoint.consumed":       true,
	"loop.budget.exhausted":               true,
	"loop.reservation.dispatch.published": true,
}
